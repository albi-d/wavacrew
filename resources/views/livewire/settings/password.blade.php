...
new class extends Component {
    ...
    /**
     * Memperbarui password untuk pengguna yang sedang login.
     */
...
<section class="w-full">
    ...
    <x-settings.layout :heading="__('Perbarui Password')" :subheading="__('Pastikan akun Anda menggunakan password yang panjang dan acak untuk menjaga keamanan')">
